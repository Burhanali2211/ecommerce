...
const slides = [
  {
    image: 'https://images.unsplash.com/photo-1547887538-e3a2f32cb1cc?w=1200&q=75&auto=format',
    title: 'Pure Attars of Aligarh',
    subtitle: 'Alcohol-free · Traditional deg-bhapka craft',
    cta: 'Shop Attars',
    ctaLink: '/products?category=attars',
    accent: 'from-amber-900/80 to-transparent',
  },
  {
    image: 'https://images.unsplash.com/photo-1541643600914-78b084683702?w=1200&q=75&auto=format',
    title: 'Premium Oud & Perfumes',
    subtitle: 'Rich, lasting fragrances for every occasion',
    cta: 'Explore',
    ctaLink: '/products?category=perfumes',
    accent: 'from-gray-900/80 to-transparent',
  },
  {
    image: 'https://images.unsplash.com/photo-1607344645866-009c320b63e0?w=1200&q=75&auto=format',
    title: 'Eid & Nikah Gift Sets',
    subtitle: 'Thoughtfully curated for your loved ones',
    cta: 'View Gifts',
    ctaLink: '/products?category=gift-items',
