    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 flex items-center justify-center p-4">
      {showBranding ? (
        <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="hidden lg:flex flex-col justify-between bg-gradient-to-br from-amber-700 via-amber-800 to-amber-900 rounded-3xl p-10 text-white overflow-hidden relative">
            {/* Decorative elements */}
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4 border-t border-white/20 pt-6">
                ...
                {/* Welcome Offer */}
                <div className="mt-6 bg-gradient-to-r from-amber-600/40 to-orange-600/40 backdrop-blur-sm rounded-xl p-4 border border-amber-400/30">
