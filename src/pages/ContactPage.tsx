...
export const ContactPage: React.FC = () => {
  ...
  const inputBase = 'w-full px-4 py-3 border rounded-xl text-sm text-gray-900 placeholder-gray-400 bg-white focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition';
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div key={label} className="bg-white rounded-xl border border-gray-100 p-4 flex flex-col gap-2">
                ...
                {href ? (
                  <a href={href} className="text-sm text-gray-800 font-medium hover:text-green-700 transition-colors line-clamp-2">{value}</a>
                ) : (
                  ...
                  {[
                    ...
                    <div key={label} className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        {href ? (
                          <a href={href} className="text-sm text-gray-800 hover:text-green-700 transition-colors whitespace-pre-line">{value}</a>
                        ) : (
