      ...
      <div className="max-w-2xl mx-auto space-y-5">
        ...
        >
          <Link
            ...
            className="w-full flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 text-white py-3.5 rounded-xl font-semibold transition-colors"
          >
