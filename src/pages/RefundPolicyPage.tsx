      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <p className="text-gray-600 leading-relaxed mb-4">
            At Aligarh Attar House, we stand behind the quality of our authentic attars, perfumes & Islamic lifestyle products.
        ...
        >
          ...
          <div className="space-y-4">
            <div className="flex items-start">
              ...
              <div>
                <p className="font-semibold text-gray-800">Opened Attar / Perfume Bottles</p>
                <p className="text-gray-600">Due to hygiene reasons, opened attar or perfume bottles cannot be returned</p>
              </div>
            </div>
            <div className="flex items-start">
              <XCircle className="w-5 h-5 text-red-600 mt-1 mr-3 flex-shrink-0" />
